...
class CashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cash" do
    assert_difference('Cash.count') do
      post cashes_url, params: { cash: { date: @cash.date, note: @cash.note, type: @cash.type, value: @cash.value } }
    end
  ...
  test "should update cash" do
    patch cash_url(@cash), params: { cash: { date: @cash.date, note: @cash.note, type: @cash.type, value: @cash.value } }
