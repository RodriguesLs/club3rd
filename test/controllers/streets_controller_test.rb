...
class StreetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post streets_url, params: { street: { cep: @street.cep, complement: @street.complement, customer_id: @street.customer_id, district: @street.district, number: @street.number, state: @street.state } }
    end
  ...
  test "should update street" do
    patch street_url(@street), params: { street: { cep: @street.cep, complement: @street.complement, customer_id: @street.customer_id, district: @street.district, number: @street.number, state: @street.state } }
